...
class CustomSeparatorSection extends StatelessWidget {
  final double? height;
  final Color? dottedColor;
  final bool isSolid;
  final Color? customColor;
  CustomSeparatorSection(
      {this.height, this.dottedColor, this.customColor, this.isSolid = false});
  @override
  Widget build(BuildContext context) {
    return dottedColor != null
        ? _buildDotted()
        : SizedBox(
            height: height ?? 10,
            ...
            child: Container(
              color: isSolid
                  ...
                  : customColor ?? ColorStyle().grayscaleRange[300],
            ),
          );
  }
